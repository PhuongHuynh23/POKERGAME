...
public class Frame
{
    public static void Screen(int width, int height)
    {
        ...
        // Vẽ hàng dưới cùng
        Console.WriteLine(new string('-', width + 2));
        Console.SetCursorPosition((width + 2) / 2 - 5, height / 2);
    }
}
// ---------------------------------------------- Define Card class --------------------------------------------------
public class Card
        ...
        foreach (var player in players)
        {
            if (player.InGame)
            {
                ...
                if (winner == 1)
                {
                    ...
                    Console.WriteLine(@"THE RESULT OF THE GAME
                                               TIE");
                    Console.ResetColor();
                    Console.ReadKey();
                }
                else if(handStrength == winner)
                {

                    Console.ForegroundColor = ConsoleColor.Yellow;
                    Console.WriteLine(@$"THE WINNER IS {player.Name}
                                    {player.Name}'s hand strength: {handStrength} ");
...
public class Program
{
    ...
    {
        Frame.Screen(84, 28);
        Console.WriteLine("Welcome to Pocket Kings !");
        ...
        //Console.WriteLine();
        //Console.WriteLine("                   You are old enough to play the game!");

        //// Hỏi về số lượng người chơi
        //int playerCount;
        //do
        //{
        //    Console.WriteLine("How many players will participate? (Minimum 2 players): ");
        ...
        //    players.Add(new Player(name, i > 0));
        //}
